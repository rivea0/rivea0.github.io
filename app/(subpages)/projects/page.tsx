  ...
  return (
    <Suspense fallback={<LoaderIcon />}>
      ...
      <Project 
        ...
        description={<>A ten-part series of blog posts that were published each week as the new problem sets arrived in <Link href="https://cs50.harvard.edu/python/2022">CS50's Introduction to Programming with Python</Link> to guide learners taking the course.</>} 
        demoHref="https://dev.to/rivea0/solving-the-problem-sets-of-cs50s-introduction-to-programming-with-python-one-at-a-time-problem-set-0-27d5" 
        isWriting={true}
        more={<>I took the original CS50 the year before, and had been diving a bit deep into Python, so when this course was first introduced, I took the challenge to take it, do the problem sets, and write about it each week on the day they arrived. It indeed proved to <Link href="https://web.archive.org/web/20231114183738/https://dev.to/rivea0/solving-the-problem-sets-of-cs50s-introduction-to-programming-with-python-one-at-a-time-problem-set-5-k44#comment-1od25">be</Link> <Link href="https://web.archive.org/web/20231114184027/https://dev.to/rivea0/solving-the-problem-sets-of-cs50s-introduction-to-programming-with-python-one-at-a-time-problem-set-8-5lf#comment-20o22">helpful</Link> for some folks.</>}
        isThirdParty={true}
